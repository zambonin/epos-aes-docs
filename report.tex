...
\begin{enumerate}
    \item[] \emph{Geração de chaves.} O esquema só pode ser utilizado para assinar um numero limitado de mensagens, para cada chave pública. Este número de mensagens 

    \item[] \emph{Gera~]ao de assinatura.}
