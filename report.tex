...
\begin{enumerate}
    ...
    \item[\textsc{MixColumns}] Esta operação é definida pela multiplicação da matriz estado por uma matriz de mesmo tamanho obtida através do polinomio $$ o resultado desta multiplicação de matrizes é uma nova matrix 4x4
