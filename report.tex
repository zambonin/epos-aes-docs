...
O principal esquema variante do \textsc{Wots}, chamado de \textsc{Wots+}~\cite{cryptoeprint:2017:965}, tem como ideia principal a utilização de uma 
família de funções com entradas pseudoaleatórias em todas as iterações, substituindo o processo sequencial (utilizando apenas uma função) do esquema original.
