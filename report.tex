...
Defina os parâmetros $m, w$ e a partir destes, $t_1, t_2 \text{ e } t$ bem como a função de resumo criptográfico $\mathcal{H} : \binwds{*} \longrightarrow \binwds{m}$ de maneira análoga ao esquema original.
