...
\begin{enumerate}
    ...
    \item[\textsc{InvMixColumns}]  Cada coluna de $A$, $A_j$, é multiplicada pela inversa multiplicativa do polinômio utilizado no \textsc{MixColumns}, de valor $c = 0B \cdot x^{3} + OD \cdot x^{2} + o9 \cdot x + 0E$, módulo $x^{4} + 1$.
