...
\begin{enumerate}
    ...
    \item[\textsc{SubBytes}] Realiza-se a substituição de $A_{i,j}$
        pelo seu valor correspondente em uma \emph{substitution-box} (\emph{S-box}, construída a partir da inversa multiplicativa do elemento sendo operado e ), onde os \emph{nibbles} mais e menos significativos, respectivamente, representam a linha e a coluna do elemento na \emph{S-box}.
