...
\begin{enumerate}
    ...
    \item[\textsc{MixColumns}] A matriz de estado é multiplicada com matriz específica, cada elemento do produto das matrizes é a soma dos produtos dos elementos de uma linha e uma coluna
