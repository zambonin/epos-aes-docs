...
\begin{enumerate}
    ...
    \item[\textsc{MixColumns}] Cada coluna da matriz de estado é m
    
    Esta operação é definida pela multiplicação da matriz estado por uma matriz de mesmo tamanho definida pelo polinomio $c = (00000011) \cdot s^{3}+(00000001) \cdot s^{2}+(00000001)*s+(00000010)$ a matriz resultante desta multiplicação é dito como o novo valor da matriz estado.
