...
\begin{enumerate}
    ...
    \item[\textsc{ShiftRows}] Para cada linha da matriz estado é feito um deslocamento circular, no qual o estado é escrito em forma matricial e as suas linhas são deslocadas de forma circular em 0,1,2 ou 3 para a esquerda
