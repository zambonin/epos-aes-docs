...
\item Na primeira rodada temos o estado definido a mensagem dividida em blocos de 16bytes, é feito um XOR bit a bit entre os bytes do estado e a chave da primeira rodada.
