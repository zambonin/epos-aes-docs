...
\begin{enumerate}
    \item[\textsc{SubBytes}] Realiza-se a substituição de cada elemento da matriz de estado pelo seu valor correspondente em uma \emph{S-Box}, i.e. uma caixa de substituições, onde, para cada byte os 4 bits mais a esquerda representam a linha da S-Box e os 4 mais a direita representam a coluna.
