...
\begin{itemize}
    ...
    Novamente, $c$ pode ser arredondado com zeros até que $w \mid \vert c \vert$. Finalmente, ele é dividido em uma $t_2$-tupla de palavras base-$w$, $\mathcal{B}_2 = (b_{t_2-1}, \dots, b_0)$. Com a realização de $\mathcal{B} = \mathcal{B}_1 \cup \mathcal{B}_2$ computed, we obtain the signature
