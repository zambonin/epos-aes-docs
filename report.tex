...
A expansão de chaves consiste da criação de um conjunto de tamanho $t = \frac{n}{32}(n_r + 1)$, denominado $K_e = \{k_0, \dots, k_{t - 1}\}$. Este tamanho é baseado na divisão de $K$ em palavras de 32 bits e na necessidade de chaves distintas para cada rodada do algoritmo.
