...
\begin{enumerate}
    ...
    Similar a operação \textsc{MixColumns}, onde cada coluna de $A$, $A_j$, é multiplicada pela inversa multiplicativa do polinômio utilizado no \textsc{MixColumns}, módulo $x^{4} + 1$, de valor $c = $.
