...
\begin{enumerate}
    ...
    \item[\textsc{MixColumns}] Esta operação é definida pela multiplicação da matriz estado por uma matriz de mesmo tamanho definida pelo polinomio $c = x03*s^{3}+x01*s^{2}+x01*s+x02$ a matriz resultado desta multiplicação é dito como o novo valor da matriz estado.
