...
Note que é possível utilizar uma função conhecida, como o AES, para as iterações de $f$. Isto pode ser explicado por conta de implementações em hardware de rotinas relacionadas, como o conjunto de instruções AES-NI da Intel.


a fim de aproveitar possíveis núcleos criptográficos dentro de processadores, que habilitam um grande desempenho para est
