...
de tamanho $n = \{128, 192, 256\}$, e retorna um conjunto de $4(n_r + 1)$ palavras de 32 bits, denominado de chave expandida.
Cada conjunto de 4 palavras sucessivas é utilizado em uma rodada do algoritmo.
As primeiras $n / 32$ entradas deste conjunto são populadas pela divisão da chave inicial em
palavras de valor . 
