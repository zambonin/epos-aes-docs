...
Os esquemas variantes do Wots, tem como ideia principal utilizar cadeias de funções com estradas pseudoaleatórias, estas são a chave privada e a saída a chave pública. Diferente de outras variantes, onde essas cadeias de funções são apenas iterações sequenciais 
