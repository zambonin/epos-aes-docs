...
calcula-se
    ...
    t = t_1 + t_2.$$
Por fim, considere as funções\footnote{É possível que o esquema seja construído utilizando \hh{} no lugar de $f$. de mão única
