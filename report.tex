...
\begin{itemize}
    ...
    Novamente, $c$ may be padded with zeroes until $w \mid \vert c \vert$. Finally, it is split into a     $t_2$-tuple of base-$w$ words $\mathcal{B}_2 = (b_{t_2-1}, \dots, b_0)$. With $\mathcal{B} =     \mathcal{B}_1 \cup \mathcal{B}_2$ computed, we obtain the signature
