...
\begin{enumerate}
    ...
    \item[] \textsc{Geraão de chaves}: Com a entrada do parâmetro de segurança $n$, em unário, o algoritmo de geração de chaves escolhe aleatoriamente $l + w - 1$ $n$-bit strings.
