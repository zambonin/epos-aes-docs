...
A expansão de chave consiste de um algoritmo que recebe uma chave de $n = \{128, 192, 256\}$ bits e retorna matrizes de tamanho suficiente para cada rodada do algoritmo, incluindo a introdutória. A chave inicial é dividida em palavras de $32$ bits, e operações são aplicadas nestas palavras de acordo com seus índices para a expansão.
