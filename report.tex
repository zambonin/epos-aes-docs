...
e funções de resumo criptográfico. Em especial, esta última opção apresenta
grande versatilidade, visto que os esquemas não necessitam de funções
específicas para seu funcionamento.


Em especial, é possível mesclar as duas
últimas opções a fim de aproveitar, respectivamente, o desempenho e a
simplicidade destas. Esta possibilidade será abordada neste trabalho a fim de
demonstrar a flexibilidade 
