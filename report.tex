...
Então, $\forall i \geq \ell, K_{e_{i}} = K_{e_{i-4}} \oplus \mathbf{k}$. A palavra $\mathbf{k}$ é decidida de acordo com as seguintes restrições. Tome $rot(x)$ como o deslocamento circular à esquerda de 8 bits da palavra $x$.
