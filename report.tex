...
\begin{enumerate}
    ...
    \item[] \emph{Geração da assinatura.} Tome uma mensagem $M$ e calcule o seu resumo $d = \mathcal{H}(M)$, produzindo $\mathcal{B}_1 = (b_{t-1}, \dots, As considerações sobre preenchimento de $m$ e $c$ ainda se aplicam.
