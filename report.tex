...
As operações realizadas em cada rodada são \textsc{SubBytes}, \textsc{ShiftRows}, \textsc{MixColumns} e \textsc{AddRoundKey}. Note que existe uma rodada adicional inicial
composta apenas de \textsc{AddRoundKey}, para que o estado inicial não seja a mensagem original, e na última rodada \textsc{MixColumns} não é realizado --- isto 
