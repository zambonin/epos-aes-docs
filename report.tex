...
A expansão de chave consiste de um algoritmo que recebe uma chave de $n = \{128, 192, 256\}$ bits e retorna matrizes de $4 \times 4$ bytes para cada rodada do algoritmo, incluindo a introdutória.
