...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Cifras de bloco podem ser utilizadas na construção de funções de mão única \cite{Merkle:1989:CDS:118209.118230}
  \end{itemize}
\end{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{.4\textwidth}
      \begin{figure}
        ...
        \caption*{Tendo $\mathcal{D}_n$ como qualquer bloco de dados. Uma árvoce Merkle pode ser construida recursivamente através da concatenação dos resumos dos filhos de um nodcan be constructed recursively through the concatenation
