...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Segurança de esquemas de assinatura digital baseada em teoria de números ou problemas algébricos
    \begin{itemize}
      \item Inseguro no âmbito de computadores quânticos
      \item Criptografia pós-quântica é independente de teoria de números ou problemas algébricos
    \end{itemize}
