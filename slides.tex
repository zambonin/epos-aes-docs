...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Independente de teoria de números ou problemas algébricos from number theory or algebraic problems
    \begin{itemize}
...
\begin{frame}
  ...
  \begin{columns}[T]
    \begin{column}{.45\textwidth}
      \begin{itemize}
        \item Assinaturas one-time em cada folha, árvore construida a partir de chaves publicas signatures on each leaf, tree built from public keys
