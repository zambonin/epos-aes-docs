...
\begin{frame}
    ...
    \begin{itemize}
        \item Cifra de blocos que opera a partir de uma chave $\mathcal{K}$
        \item Chave de tamanho $n = \{128, 192, 256\}$
        \item Opera sobre uma matriz $A, A_{i,j} \in \mathbb{F}_{2^8}, 0 \leq i, j \leq 3$
    \end{itemize}
\end{frame}
