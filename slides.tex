...
\begin{frame}
    ...
    % \end{itemize}
		...
		%% SBoxes
% 		\foreach \z in {0,...,3} {
			\node[draw,thick,minimum width=2.75em,minimum height=2em,fill=white] (p4) at ($(3em,0) + (1.1em,-2em)$) {$S$};
			\node[draw,thick,minimum width=11em,minimum height=2em,fill=white] (p4) at ($(3em,0) + (1.1em,-11em)$) {$S$};
% 		}
