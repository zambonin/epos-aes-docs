...
\begin{frame}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{.25\textwidth}
            ...
            \caption*{Pictogramas para as etapas \emph{SubBytes} (acima) e \emph{InvSubBytes}.}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{.25\textwidth}
            ...
            \caption*{Pictogramas para as etapas \emph{ShiftRows} (acima) e \emph{InvShiftRows}.}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{.25\textwidth}
            ...
            \caption*{Pictogramas para as etapas \emph{MixColumns} (acima) e \emph{InvMixColumns}.}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
