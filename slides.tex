...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item Escolhida situacionalmente according to specific needs (hardware, software)
    \end{itemize}
  ...
  \begin{columns}[T]
    \begin{column}{.45\textwidth}
      \begin{itemize}
        ...
        \item Maneiras esperClever ways to store the key pair (e.g. seed of pseudorandom generator)
