...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Tripla de algoritmos probabilísticos de tempo polinomial
      \cite{Goldreich2004}
    \begin{itemize}
      \item Geração de chaves (\textsc{Gen}), geração da assinatura ($\mathcal{S}$),\\
...
\begin{frame}
  ...
  \end{align*}
  Para verificar $\sigma$, todo $\epsilon_i$ é calculado e a cadeia de resumo é completada are calculated and the hash chains are finished:
  \begin{align*}
