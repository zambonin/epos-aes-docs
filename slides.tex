...
\usepackage{amsmath, graphicx, hyperref, mathtools, subcaption, tikz, tikz-qtree}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Adição equivalente a \texttt{AND}, multiplicação a $\oplus \pmod{x^8 + x^4 + x^3 + x + 1}$
        \end{itemize}
    \end{itemize}
\end{frame}
