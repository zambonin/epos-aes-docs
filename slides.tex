...
\begin{frame}
  ...
  Seja $w \in \mathbb{N}, w > 1$ o parametro de compensação Winternitz. Entao,
   \begin{align*}
       ...
       \frac{\lfloor log_2 t_1 \rfloor + 1 + w}{w} \right\rceil \\
         t &= t_1 + t_2
   \end{align*}
   As chaves privada e pública são, respectivamente,The private and public keys are, respectively,
   \begin{align*}
