...
\begin{frame}
  ...
  \begin{itemize}
      ...
      \begin{itemize}
        \item Entrada $x$, saída $h$
        \item $x = (x_0, \dots, x_{k - 1}$, $\vert x_i \vert = n$ é dividida em $t$ blocos de tamanho $n$ para a cifra $E$
        \item Tome um valor inicial $IV$, $\vert IV \vert = n$
        \item Saída $h$
      \end{itemize}
  \end{itemize}
\end{frame}
