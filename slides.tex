  ...
  \begin{columns}[T]
    ...
    \begin{column}{.4\textwidth}
      \begin{figure}
        ...
        \caption*{Tendo $\mathcal{D}_n$ como qualquer bloco de dados. Uma árvoce Merkle pode ser construida recursivamente através da concatenação dos resumos dos filhos de um nodocan be constructed recursively through the concatenation
