...
\begin{frame}
    ...
    \framesubtitle{Etapa \emph{AddRoundKey} e rotina \emph{KeyExpansion}}
          \begin{itemize}
            % \item \emph{AddRoundKey}: ou exclusivo de $A$ com parte da chave expandida
            \item \emph{KeyExpansion}: chave expandida $K^e$, $\ell = \frac{\vert K \vert}{32}$ palavras por rodada
            \item Rotina gera palavras de 32 bits; $\ell = \frac{\vert K \vert}{32}$
